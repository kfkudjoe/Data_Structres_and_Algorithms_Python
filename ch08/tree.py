...
class Tree:
    ...
    class Position:
        ...
        Therefore, users should always rely on the syntax 'p == q' rather than 'p is q' when
        testing the equivalence of a position.
        """
    ...
    def postorder(self):
        # Generate a postorder iteration of positons in the tree
        if not self.is_empty():
            for p in self._subtree_postorder(self.root()):      # start recursion
                yield p

    def _subtree_postorder(self, p):
        # Generate a postorder of positions in subtree rooted at p
        for c in self.children(p):      # for each child c
        ...
        if not self.is_empty():
            ...
            while not fringe.is_empty():
                ...
                for c in self.children(p):
                    finge.enqueue(c)        # add children to back of queue
