def matrix_chain(d):
    ...
    # 
    # d is a list of n + 1 numbers describing the dimensions of a chian 
    # of n matrices such that kth matix has dimensions d[k]-by-d[k+1].
    # 
    # Return an n-by-n table such that N[i][j] represents the minimun number
