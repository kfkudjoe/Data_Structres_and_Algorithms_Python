def DFS(g, u, discovered):
    ...
    # 
    # Discovered is a dictionary mapping each vertex to the edge that was used to discover it
    # during the DFS. (u should be "discovered" prior to the call).
...
def DFS_complete(g):
    ...
    # 
    # Result maps each vertex v to the graph edge that was used to discover it.
    # (Vertices that are roots of a DFS tree are mapped to None.)
    forest = {}

    for u in g.vertices():
        if u not in forest:
            forest[u] = None        # u will be the root of at ree
            DFS(g, u, forest)
        return forest