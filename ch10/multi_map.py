class MultiMap:
    ...
    As an example, one might define the following subclass to use as a SortedTableMap
    ...
    def pop(self, k):
        # Remove and return arbitrary (k, v) pair with key k.
        # Raise KeyError
    ...
    def find(self, k):
        # Return arbitrary (k, v) pair with given key k.
        # Raise KeyError.
